...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2023/02/03 03:20:54 by odouhri           #+#    #+#              #
#    Updated: 2023/08/02 16:26:37 by odouhri          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = ft_printf.c ft_printptr.c ft_printf_utils.c ft_print_unsigned.c ft_print_hex.c
